...
function buildDefaultServiceEntries(): ServiceEntry[] {
  ...
  return [
    ...
    {
      id: 'default-road-materials',
      title: '路牌物料',
      description: '生成道路路牌和楼栋地名标志图片。',
      categoryId: 'toolbox',
      icon: 'signpost',
      href: '/services/road-materials',
      openMode: 'same_tab',
      status: 'published',
      sortOrder: 35,
      publishedAt: now,
    ...
    {
      id: 'default-transit-materials',
      title: '公共交通导视',
      description: '从已发布线路生成公交导视物料。',
      categoryId: 'toolbox',
      icon: 'directions_bus',
    ...
    },
    {
      ...
      title: '电报体验',
      description: '填写、拍发并接收一封拟真电报。',
      categoryId: 'toolbox',
      icon: 'newspaper',
      href: '/services/telegraph',
      openMode: 'same_tab',
      status: 'published',
      sortOrder: 70,
      publishedAt: now,
