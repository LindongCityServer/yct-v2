(function initializeLindongPortalI18n() {
  ...
  const translations = Object.freeze({
    'zh-CN': Object.freeze({
      ...
      'tools.title': '创作工具',
      'tools.intro': '路牌、公共交通导视与动态线路图都可独立使用。选择一个任务，直接开始创作。',
      ...
      'tools.transitDescription':
        '使用服务器线网或导入的 <abbr title="地铁线路图绘制器（Rail Map Painter）">RMP</abbr> 项目，制作公交站牌与轨道交通导视。',
      ...
      'tools.legacyLabel': '尚未迁移的工具',
      'tools.notMigrated': '尚未迁移',
    ...
    'zh-Hant': Object.freeze({
      ...
      'tools.title': '創作工具',
      'tools.intro': '路牌、公共交通導視與動態路線圖都可獨立使用。選擇一個任務，直接開始創作。',
      ...
      'tools.transitDescription':
        '使用伺服器路網或匯入的 <abbr title="地鐵路線圖繪製器（Rail Map Painter）">RMP</abbr> 項目，製作公車站牌與軌道交通導視。',
      ...
      'tools.legacyLabel': '尚未遷移的工具',
      'tools.notMigrated': '尚未遷移',
    ...
    en: Object.freeze({
      ...
      'tools.intro':
        'Create street signs, transit wayfinding and live route displays as standalone projects.',
      ...
      'tools.transitDescription':
        'Use the server network or an imported <abbr title="Rail Map Painter">RMP</abbr> project to create bus stop and metro wayfinding.',
      ...
      'tools.legacyLabel': 'Tools awaiting migration',
      'tools.notMigrated': 'Awaiting migration',
